...
def evaluate():
  ...
  filenames = glb('../data/dataset/train_FDHS_nagetive_1018_20210401/*')
  ...
  with tf.Graph().as_default():
    ...
    csvfile = open('prediction_score_train_FDHS_nagetive_1018_20210401_1144490.csv', 'w') 
...
#      print(metric_min_area_rect_iou(generated_mask,ground_truth_mask))
      ...
      save_prediction_path = '../data/prediction_score_train_FDHS_nagetive_1018_20210401_1144490/'
